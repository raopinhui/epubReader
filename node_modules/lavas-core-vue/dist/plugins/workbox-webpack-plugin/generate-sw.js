...
class GenerateSW {
      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return getWorkboxSWImports(compilation, _this.config);

            case 2:
              workboxSWImports = _context.sent;
              entries = getManifestEntriesFromCompilation(compilation, _this.config);
              ...
              _this.config.importScripts.push((compilation.options.output.publicPath || '') + manifestFilename);
              ...
              if (workboxSWImports) {
                ...
                _this.config.importScripts = _this.config.importScripts.concat(workboxSWImports);
              }

              sanitizedConfig = sanitizeConfig.forGenerateSWString(_this.config);
            ...
            case 15:
              ...
              compilation.assets[_this.config.swDest] = convertStringToAsset(serviceWorker);
  ...
  apply(compiler) {
    ...
    compiler.plugin('emit', function (compilation, callback) {
      _this2.handleEmit(compilation).then(callback).catch(callback);
    });
  }
}
