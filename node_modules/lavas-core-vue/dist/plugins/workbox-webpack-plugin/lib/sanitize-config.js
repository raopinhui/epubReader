...
function forGetManifest(originalConfig) {
  var propertiesToRemove = ['chunks', 'exclude', 'excludeChunks', 'importScripts', 'importWorkboxFrom', 'include', 'swDest', 'swSrc', 'test', 'manifestFilename'];
...
function forGenerateSWString(originalConfig) {
  var propertiesToRemove = ['chunks', 'exclude', 'excludeChunks', 'importWorkboxFrom', 'include', 'swDest', 'test'];
