    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.next = 6;
            return copyWorkboxLibraries(compilation.options.output.path);

          case 6:
            wbDir = _context.sent;
            workboxSWImport = (compilation.options.output.publicPath || '') + wbDir + '/workbox-sw.js';
          ...
          case 16:
            ...
            return _context.abrupt('return', chunk.files);
