...
class ProdBuilder extends _baseBuilder2.default {
    ...
    build() {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            ...
            // clear dist/ first
            _logger2.default.info('build', `准备清理 ${build.path}...`, true);
            yield (0, _fsExtra.emptyDir)(build.path);
            _logger2.default.info('build', `${build.path} 清理完成`, true);

            _logger2.default.info('build', '自动生成路由规则...', true);
            yield _this.routeManager.buildRoutes();
            _logger2.default.info('build', '路由规则生成完成', true);

            _logger2.default.info('build', '写入临时文件', true);
            yield _promise2.default.all([_this.writeRuntimeConfig(), _this.writeMiddleware(), _this.writeStore()]);
            _logger2.default.info('build', '临时文件写入完成', true);
