...
function inner(customTemplate, ssr, baseUrl) {
    ...
    _logger2.default.warn('build', 'core/index.html.tmpl 已经过期');
    _logger2.default.warn('build', '您可以查看 https://lavas.baidu.com/guide/v2/advanced/core#indexhtmltmpl 获得更多信息\n');
