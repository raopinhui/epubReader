...
class ConfigReader {
    ...
    read() {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            ...
            if (_this.customConfigPath) {
                _logger2.default.info('build', `读取自定义配置： ${_this.customConfigPath}...`, true);
            ...
            if (yield (0, _fsExtra.pathExists)(singleConfigPath)) {
                _logger2.default.info('build', '读取 lavas.config.js...', true);
                ...
                _logger2.default.info('build', '读取配置完成', true);
                return config;
            }

            // read from config/
            _logger2.default.warn('build', '从 config 目录读取配置已经过时，请尝试把配置写到 lavas.config.js 中');
    ...
    readConfigFile() {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            _logger2.default.info('build', '开始读取配置...', true);
            ...
            _logger2.default.info('build', '配置读取完成', true, true);
            return parsedConfig;
        })();
    }
}
